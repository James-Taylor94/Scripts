<#
.SYNOPSIS
    This script is designed to create GROH accounts
.DESCRIPTION
...
$Logfile = "\\dhw.wa.gov.au\CorporateData\IS\TSS\Support Centre\EntOps\Scripts\Logs\GrohAccountCreationLog_$Today.log"
...
$Group = "External Domain Users","APP_PATH_Users"
...
Set-ADUser -Identity $SamAccountName -Replace @{employeeType = 'External Groh' } -Server $Server
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhQqXNaLSKWAX1wRq/liPlmzH
# QgegghJRMIIFFzCCAv+gAwIBAgIQdexlXsRJKYlLPymgWWJPNjANBgkqhkiG9w0B
...
# IwYJKoZIhvcNAQkEMRYEFP7rY/Y5NdYCM5U63CJndA2v/mvNMA0GCSqGSIb3DQEB
# AQUABIIBAF/s4aXxFOfqkGgnyZ5uSFD2+h+CeIyWAzf/u16+ypzBFkB2PPGo6sOf
# KZ60lbfStohue6CyHqXHINnbyDkHlh/+ZP5LR8cPGPETY/2/CmwP/fZPioAAwR7L
# lIUIjcZyAtSrp7R5ADpd+aOjCeyMoCgSQl44fNqHct14sjBtmgsCKa4c5SLNUPtl
# yMy3pJHftsQ4CHzXfYwg+1w7TQEa2k99c9I1IW/ay6A9oytHyoENKKhByWc7y/yT
# NFbrUVicz1NVIe6oqcumlZfAFhRRZNt7GL5SGxSjPHBLTfFsPlnouQ48/IODXhlD
# O+GEg9F2Z+r53rWi4JucNVf+7O0L/4E=
