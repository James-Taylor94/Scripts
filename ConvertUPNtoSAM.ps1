...
$Users = Get-Content 'C:\temp\Imports\UPNtoSAM.csv'

$Users | ForEach-Object {(Get-ADUser -Filter "DisplayName -eq '$_'" -Properties *).UserPrincipalName} -verbose | Out-File "C:\temp\Exports\BulkAdd.txt"