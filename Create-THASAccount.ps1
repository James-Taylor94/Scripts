<#
.SYNOPSIS
    This script is designed to create THAS accounts
.DESCRIPTION
...
$Logfile = "\\dhw.wa.gov.au\CorporateData\IS\TSS\Support Centre\EntOps\Scripts\Logs\THASAccountCreationLog_$Today.log"
...
$Manager = Read-Host "Enter the DoC Responsible Managers username"
...
$Group = "External Domain Users","APP_THAS_Users","App-WVD-RemoteApp.05.BusinessApps-ExternalUsers.P","Auth-MFA.Azure.ExternalRegistration.Allow","APP_Microsoft_Office_365_EMS_Users_E3", "App-Microsoft-Office365-Communities.SecurityBaseline"
...
Set-ADUser -Identity $SamAccountName -Replace @{employeeType = 'External THAS' } -Server $Server
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULMT2wLelXOf+tcKu4fOQlRq3
# y66gghJRMIIFFzCCAv+gAwIBAgIQdexlXsRJKYlLPymgWWJPNjANBgkqhkiG9w0B
...
# IwYJKoZIhvcNAQkEMRYEFFE4f9jGkEeo/rEhpHy0EmNhzXTdMA0GCSqGSIb3DQEB
# AQUABIIBALoN+PgOuUe2BBG58FO69kj6Y01Xuo0DTAjsky+WAQkaYB3hdUgb3Iji
# IpMXinM3QJzrHUv3LNIwWedIUeNZrfKSiT8qZzHE3AuSEvcsgte513cpdK7k+g9U
# 2iGpClbnIBKwqdW62QqaUNa29th6dwwEqRPlMWdHjlb2EzTMBWdD8jhuRa8+ik/4
# 9K4/b4n0nmMWl1GowRxj1LugrPnNbHCbFd0G0mfD+OPGPSGHIXivuODB3nvO8jFB
# wWFt4OsbQVfENTeT67oW9/OeG/aKvTqhTUeeFGWyFcc3Jd4KcHdacXVABHX02GS3
# 0zJpgwMuYb4z4j1iEPOypjiMeemkPZM=
